...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($address_err) && empty($phone_err)){
        ...
        $sql = "UPDATE departments SET department_name=?, department_address=?, department_phone=? WHERE department_id=?";
 
        if($stmt = $mysqli->prepare($sql)){
            // Bind variables to the prepared statement as parameters
            $stmt->bind_param("sssi", $param_name, $param_address, $param_phone, $param_id);
